...
public class KochSchneeflocke {
    ...
    public static void main(String[] args) {
        ...
        // Das Zeichnen erfolgt dann im Hintergrund und wird erst
    ...
    /**
    * Zeichnet rekursiv eine Kochkurve mit der uebergebenen Tiefe
    ...
    * @param x1    - x-Koordinate des Beginns des aktuellen Linienabschnitts
